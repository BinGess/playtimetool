...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'zh': {
      ...
      'penaltyCountry': '惩罚国家',
      'penaltyCountrySub': 'COUNTRY',
      'penaltyDifficulty': '惩罚难度',
      'penaltyDifficultySub': 'DIFFICULTY',
      'penaltyScale': '惩罚尺度',
      'penaltyScaleSub': 'SCALE',
      'penaltySelectionMode': '结果选择',
      'penaltySelectionModeSub': 'SELECTION MODE',
      'language': '语言',
      ...
      'penaltyCountryCn': '中国',
      'penaltyCountryUs': '美国',
      'penaltyDifficultyEasy': '轻松',
      'penaltyDifficultyNormal': '标准',
      'penaltyDifficultyHard': '硬核',
      'penaltyScaleLight': '轻度',
      'penaltyScaleMedium': '中等',
      'penaltyScaleWild': '狂野',
      'penaltySelectionManual': '手动选择',
      'penaltySelectionRandom': '随机推荐',
      'penaltyRandom': '随机',
      'penaltyChoose': '选择',
      'penaltyApply': '应用',
    ...
    'en': {
      ...
      'alcoholPenaltySub': 'ALCOHOL / PURE MODE',
      'penaltyCountry': 'Penalty Country',
      'penaltyCountrySub': 'COUNTRY',
      'penaltyDifficulty': 'Penalty Difficulty',
      'penaltyDifficultySub': 'DIFFICULTY',
      'penaltyScale': 'Penalty Scale',
      'penaltyScaleSub': 'SCALE',
      'penaltySelectionMode': 'Result Selection',
      'penaltySelectionModeSub': 'SELECTION MODE',
      'language': 'Language',
      'languageSub': 'LANGUAGE',
      'about': 'About',
      ...
      'contact': 'Contact',
      'penaltyCountryCn': 'China',
      'penaltyCountryUs': 'United States',
      'penaltyDifficultyEasy': 'Easy',
      'penaltyDifficultyNormal': 'Normal',
      'penaltyDifficultyHard': 'Hard',
      'penaltyScaleLight': 'Light',
      'penaltyScaleMedium': 'Medium',
      'penaltyScaleWild': 'Wild',
      'penaltySelectionManual': 'Manual',
      'penaltySelectionRandom': 'Random',
