...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'zh': {
      ...
      // Left Right
      'leftRightRule': '每位玩家两次机会，错误或超时记罚分',
      ...
      'wordBombFoodWords': '火锅|奶茶|披萨|麻辣烫|汉堡',
      'wordBombMovieWords': '科幻片|喜剧片|爱情片|动画片',
      'wordBombTravelWords': '海边|雪山|古镇|夜市',
      'wordBombNext': '下一个',
    ...
    'en': {
      ...
      // Left Right
      'leftRightRule': 'Two attempts each. Wrong/timeout adds penalty',
      ...
      'wordBombFoodWords': 'Pizza|Burger|Noodles|Taco|Sushi',
      'wordBombMovieWords': 'Sci-fi|Comedy|Romance|Animation',
      'wordBombTravelWords': 'Beach|Mountain|Old Town|Night Market',
      'wordBombNext': 'Next',
