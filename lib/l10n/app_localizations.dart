...
class AppLocalizations {
  ...
  static const _localizedValues = <String, Map<String, String>>{
    'zh': {
      ...
      'gravityBalanceDifficultyEasyHint': '路径更直，摆动较弱，适合热身',
      'gravityBalanceDifficultyMediumHint': '弯道与摆动均衡，节奏更紧张',
      'gravityBalanceDifficultyHardHint': '高曲率路径+强摆动，容错最低',
    ...
    'en': {
      ...
      'gravityBalanceDifficultyEasyHint':
          'Near-straight route with lighter sway',
      'gravityBalanceDifficultyMediumHint':
          'Balanced bends and sway with higher pressure',
      'gravityBalanceDifficultyHardHint':
          'High-curvature route and heavy sway, lowest tolerance',
